...
damping = 2  # global damping constant (reduce as more points are connected to the same object)
collisionTolerance = 0.01  # global collision tolerance (since computer programs aren't perfect unlike in real life 😭) (must lower when increasing calcRate or decreasing physicsTime; refer to collisionToleranceTables for values obtained through testing)
