...
class Main:
    def __init__(self):
        ...
        self.__voidBox = [VoidBox([-1, 0, 0], 'point'), VoidBox([-1, 0, 0], 'trash'), VoidBox([1, 0, 0], 'collisionRect'), VoidBox([1, 0, 0], 'trash'), VoidBox([0, -2, 0], 'trash', True)]  # make the summoner void boxes also trash cans
        if imports:
            self.__importData()
        ...
        for c in range(controlsConf.controllerAmt):
            ...
            if (not self.__buttonHeld['GUISelector'][c]) and buttonPressed('GUISelector', controlsConf.controllers[c], c):
                ...
                if self.__GUI['GUISelector']['']['main'] is None:
                    self.__GUI['GUISelector']['']['main'] = myGUI.GUISelector(spriteCreatorVars, controls.hand[c].cords, [controlsConf.controllers[0], controls.hand[0]], [controlsConf.controllers[1], controls.hand[1]])
                else:
    ...
    def __setRadiusDensityGUI(self, cords, p):
        if self.__GUI[p + 1000]['slider']['radius'] is None:  # only summon if GUI is empty
            if mode == 'vr':
                self.__GUI[p + 1000]['slider']['radius'] = myGUI.Slider(0, self.points[p].radius, self.points[p].origRadius, [cords[0], cords[1] + 0.5, cords[2]], 10, 0.1, maxRadius, minRadius, 'Radius', [controlsConf.controllers[0], controls.hand[0]], [controlsConf.controllers[1], controls.hand[1]])
            else:
                self.__GUI[p + 1000]['slider']['radius'] = myGUI.Manual(0, self.points[p].radius, self.points[p].origRadius, [cords[0], cords[1] + 0.5, cords[2]], 'Radius', [controlsConf.controllers[0], controls.hand[0]], [controlsConf.controllers[1], controls.hand[1]])
        else:
        ...
        if self.__GUI[p + 1000]['slider']['density'] is None:  # only summon if GUI is empty
            if mode == 'vr':
                self.__GUI[p + 1000]['slider']['density'] = myGUI.Slider(0, self.points[p].density, self.points[p].origDensity, [cords[0], cords[1] - 0.5, cords[2]], 10, 0.1, 10000, 1, 'Density', [controlsConf.controllers[0], controls.hand[0]], [controlsConf.controllers[1], controls.hand[1]])
                ...
                self.__GUI[p + 1000]['slider']['density'] = myGUI.Manual(0, self.points[p].density, self.points[p].origDensity, [cords[0], cords[1] - 0.5, cords[2]], 'Density', [controlsConf.controllers[0], controls.hand[0]], [controlsConf.controllers[1], controls.hand[1]])
        else:
                    ...
                    for axis in range(3):
                        ...
                        if mode == 'vr':
                            ...
                            if axis != 0:  # don't prevent the only closeButton remaining from being removed!
                                self.__GUI[self.__GUIType[3][0]][self.__GUIType[1][0].lower()][axis].closeButton.setPos(closeButtonCords, True)
                    self.__GUI[self.__GUIType[3][0]][self.__GUIType[1][0].lower()]['density'] = myGUI.Manual(0, self.collisionRect[self.__GUIType[3][0]].density, 1000, [controls.hand[0].cords[0], controls.hand[0].cords[1] + yDisp, controls.hand[0].cords[2]], 'Density', [controlsConf.controllers[0], controls.hand[0]], [controlsConf.controllers[1], controls.hand[1]], False)
                    self.__GUI[self.__GUIType[3][0]][self.__GUIType[1][0].lower()]['angle'] = myGUI.Manual(0, self.collisionRect[self.__GUIType[3][0]].angle[2], 0.001, [controls.hand[0].cords[0] + xDisp, controls.hand[0].cords[1] + yDisp, controls.hand[0].cords[2]], 'Angle', [controlsConf.controllers[0], controls.hand[0]], [controlsConf.controllers[1], controls.hand[1]], False)
                    self.__GUI[self.__GUIType[3][0]][self.__GUIType[1][0].lower()]['viscosity'] = myGUI.Manual(0, self.collisionRect[self.__GUIType[3][0]].viscosity, 1, [controls.hand[0].cords[0] + xDisp * 2, controls.hand[0].cords[1] + yDisp, controls.hand[0].cords[2]], 'Viscosity', [controlsConf.controllers[0], controls.hand[0]], [controlsConf.controllers[1], controls.hand[1]], False)
